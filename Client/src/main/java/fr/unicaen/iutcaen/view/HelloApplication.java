...
import fr.unicaen.iutcaen.viewTest.PelletView;
import fr.unicaen.iutcaen.viewTest.PlayerView;
...
public class HelloApplication extends Application {
    ...
    private void setupGame(Pane worldPane) {
        ...
        fr.unicaen.iutcaen.viewTest.PlayerView pv = new PlayerView(p, worldPane);
